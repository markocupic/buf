...
INSERT INTO `tl_cron` VALUES (1,'lastrun','1449240540'),(2,'monthly','201512'),(3,'weekly','201549'),(4,'daily','20151204'),(5,'hourly','0'),(6,'minutely','0');
...
CREATE TABLE `tl_voting` (
  ...
  KEY `student` (`student`),
  KEY `subject` (`subject`)
) ENGINE=MyISAM AUTO_INCREMENT=89068 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-12-05 21:57:36
