...
INSERT INTO `tl_cron` VALUES (1,'lastrun','1449817680'),(2,'monthly','201512'),(3,'weekly','201550'),(4,'daily','20151211'),(5,'hourly','0'),(6,'minutely','0');
...
INSERT INTO `tl_session` VALUES (931,3,1449864790,'BE_USER_AUTH','d085a8ccafac96cc93200d12843f6bbf','1ac3ca6bce57fb82b802f976f95fce9d838998fd','85.4.182.112',''),(930,3,1449864790,'FE_USER_AUTH','d085a8ccafac96cc93200d12843f6bbf','8e103a2ece1775ca542a6a424911fe8dc7e3603a','85.4.182.112',''),(929,3,1449866621,'FE_USER_AUTH','7c6018a6aa027ab6256008781e7eebe7','e5865019197f0c30ef296bfd81b046b7e860ccb1','85.4.182.112',''),(933,5,1449868166,'FE_USER_AUTH','49d562827a299d3181d575c86ba7e0b6','c2d3c41d09c7c9ad4f049edf840114f8143b766e','158.181.103.37','');
...
CREATE TABLE `tl_voting` (
  ...
  KEY `student` (`student`),
  KEY `subject` (`subject`)
) ENGINE=MyISAM AUTO_INCREMENT=89188 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-12-12 10:15:32
