...
INSERT INTO `tl_session` VALUES (824,3,1448479864,'FE_USER_AUTH','ae155dbe577b3c57db5e7d009a64e324','f662385e4f03a73db273e743da9377d56a24e48a','85.4.182.112',''),(825,3,1448480376,'FE_USER_AUTH','3f056861ddfc0c65bdebe7cdcd49f836','643673f7fe5fe062a5d16164740b97420fdd595a','85.4.182.112','');
...
CREATE TABLE `tl_voting` (
  ...
  KEY `student` (`student`),
  KEY `subject` (`subject`)
) ENGINE=MyISAM AUTO_INCREMENT=89023 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-11-26 12:33:25
