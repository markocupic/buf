...
INSERT INTO `tl_cron` VALUES (1,'lastrun','1449129120'),(2,'monthly','201512'),(3,'weekly','201549'),(4,'daily','20151203'),(5,'hourly','0'),(6,'minutely','0');
...
CREATE TABLE `tl_voting` (
  ...
  KEY `student` (`student`),
  KEY `subject` (`subject`)
) ENGINE=MyISAM AUTO_INCREMENT=89026 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-12-04 15:49:22
