...
INSERT INTO `tl_cron` VALUES (1,'lastrun','1449522540'),(2,'monthly','201512'),(3,'weekly','201550'),(4,'daily','20151207'),(5,'hourly','0'),(6,'minutely','0');
...
INSERT INTO `tl_session` VALUES (858,3,1449523376,'FE_USER_AUTH','184f39f4a23a382fbbda54c5279dc91d','b33bdda7cc49e09088abe30f81dcd97b4727df4a','85.4.182.112',''),(857,3,1449522304,'FE_USER_AUTH','9896dafdfea161b5b5a85e6dd781a99e','4160a72b87573d46485628ef44cf8d8221c5f7f2','85.4.182.112',''),(855,3,1449522571,'FE_USER_AUTH','cd2b07659e153aebb18b01989434f7da','2fa7730b4678a4b9888aa1c0f0ba424ea86f0d48','85.4.182.112',''),(856,3,1449522571,'BE_USER_AUTH','cd2b07659e153aebb18b01989434f7da','38da71c9a79af5d4be84dc389213e74b2a943c68','85.4.182.112','');
...
CREATE TABLE `tl_voting` (
  ...
  KEY `student` (`student`),
  KEY `subject` (`subject`)
) ENGINE=MyISAM AUTO_INCREMENT=89079 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-12-08 11:02:17
