...
INSERT INTO `tl_cron` VALUES (1,'lastrun','1436992680'),(2,'monthly','201507'),(3,'weekly','201529'),(4,'daily','20150715'),(5,'hourly','0'),(6,'minutely','0');
...
INSERT INTO `tl_session` VALUES (630,1,1436992987,'BE_USER_AUTH','1ad96a12844c47df4d3111831d8e0849','3b0c1d18598c37ff488710cb7b9096b5a44eb544','188.60.76.204','');
...
CREATE TABLE `tl_voting` (
  ...
  KEY `student` (`student`),
  KEY `subject` (`subject`)
) ENGINE=MyISAM AUTO_INCREMENT=88760 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-07-27 12:46:41
