...
INSERT INTO `tl_cron` VALUES (1,'lastrun','1449911700'),(2,'monthly','201512'),(3,'weekly','201550'),(4,'daily','20151212'),(5,'hourly','0'),(6,'minutely','0');
...
INSERT INTO `tl_session` VALUES (943,3,1449949599,'FE_USER_AUTH','3b8c54707af2e8584f32092cbee8c06f','224fea1d8035436ac3103d8ed71fdb1259c58051','85.4.182.112',''),(944,3,1449949599,'BE_USER_AUTH','3b8c54707af2e8584f32092cbee8c06f','ae7e8547b0516069ad59acf4dfcaaa2b9138f392','85.4.182.112','');
...
CREATE TABLE `tl_voting` (
  ...
  KEY `student` (`student`),
  KEY `subject` (`subject`)
) ENGINE=MyISAM AUTO_INCREMENT=89218 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-12-13  7:31:55
