...
INSERT INTO `tl_cron` VALUES (1,'lastrun','1449003600'),(2,'monthly','201512'),(3,'weekly','201549'),(4,'daily','20151201'),(5,'hourly','0'),(6,'minutely','0');
...
INSERT INTO `tl_session` VALUES (834,3,1449003644,'FE_USER_AUTH','83c9404d688a2f9c97987829f1522e67','34679c943e06f721247eec53e9155e68d66faf19','85.4.182.112','');
...
CREATE TABLE `tl_voting` (
  ...
  KEY `student` (`student`),
  KEY `subject` (`subject`)
) ENGINE=MyISAM AUTO_INCREMENT=89025 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-12-03  8:52:12
