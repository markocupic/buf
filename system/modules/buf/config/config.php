...
$GLOBALS['BE_MOD']['buf'] = array(
       ...
       'class' => array('tables' => array('tl_class'), 'icon' => 'files/buf/images/backend/mgroup.gif'), 'student' => array('tables' => array('tl_student'), 'icon' => 'files/buf/images/backend/member.gif'), 'voting' => array('tables' => array('tl_voting'), 'icon' => 'files/buf/images/backend/preview.gif'), 'subject' => array('tables' => array('tl_subject'), 'icon' => 'files/buf/images/backend/featured.gif'));
...
if (TL_MODE == 'FE')
{
       $GLOBALS['TL_JAVASCRIPT'][] = 'files/buf/js/main.js';
}
